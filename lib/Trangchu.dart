...
import 'package:duancuoiky/recipe_service.dart';
...
class _TrangchuState extends State<Trangchu> {
  ...
  final DatabaseReference dbRef3 =
      FirebaseDatabase.instance.ref("monanyeuthich");
  final DatabaseReference dbRef4 =
      FirebaseDatabase.instance.ref("nuocuongyeuthich");
  List<Map<String, dynamic>> recipes = [];
  List<Map<String, dynamic>> drinks = [];
  final RecipeService recipeService = RecipeService();
  final RecipeService recipeService2 = RecipeService();
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        _saveFavoritem(recipe['key'], "monan");
                                      },
                                      child: const Icon(
  ...
  void _saveFavoritem(String recipeId, String category) {
    recipeService.saveFavoriteRecipe(recipeId, category);
  }

  void _saveFavorited(String drinkId, String category) {
    recipeService2.saveFavoriteRecipe(drinkId, category);
  }
}
